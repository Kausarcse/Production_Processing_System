        ...
        if(mysqli_num_rows($result_from_own)>0)
            {
               ...
               <td>
                ...
                <td><input type="text" class="form-control" id="man_power_<?php echo $counter;?>" name="man_power_<?php echo $counter;?>" value="<?php echo $default_man_power?>" disabled></td>
                <td>
        ...
        ?>
           <tr> <?php  $counter++;
               ...
               ?>
                ...
                <td><input type="text" class="form-control" id="quantity_<?php echo $counter;?>" name="quantity_<?php echo $counter;?>" value="" required></td>
                <td><input type="text" class="form-control" id="man_power_<?php echo $counter;?>" name="man_power_<?php echo $counter;?>" value="<?php echo $default_man_power?>" disabled></td>
                <td>
            ...
            <input type="hidden" id="line_<?php echo $counter;?>" name="line_<?php echo $counter;?>" value="<?php echo $line_no?>">
                ...
                <td>
                    ...
                    ?>
                        ...
                        <select  class="form-control for_auto_complete" id="hour_<?php echo $counter;?>" name="hour_<?php echo $counter;?>" onchange="change_man_power(this.value,<?php echo $counter?>)">
                            <option select="selected" value="<?php echo $hour_no?>"><?php echo $hour_no?></option>
            ...
            <?php
                ...
                if(mysqli_num_rows($result_from_own)>0)
                {
                    ...
                    while( $row_from_own = mysqli_fetch_array( $result_from_own))
                    {
                        ...
                        <select  class="form-control for_auto_complete" id="hour_<?php echo $counter;?>" name="hour_<?php echo $counter;?>" value="<?php echo $row_from_own['hour']?>" disabled>
                                <option select="selected" value="<?php echo $row_from_own['hour_no']?>"><?php echo $row_from_own['hour_no']?></option>
                                <?php     
...
if($j<20)
{
    ...
    for ($i=$j; $i <=20; $i++) {
        ...
        // {
         ...
         $sql_from_own = "SELECT  * FROM line_wise_output_per_hour where input_date='$input_date' AND line_no='$i'";
        $result_from_own= mysqli_query($con,$sql_from_own) or die(mysqli_error($con));
        if(mysqli_num_rows($result_from_own)>0)
            {
                $find_same_line=$i;
                while( $row_from_own = mysqli_fetch_array( $result_from_own))
                {
                   ...
                   $counter++;
                    ...
                    <td>
                    <select  class="form-control for_auto_complete" id="style_<?php echo $counter;?>" name="style_<?php echo $counter;?>">
                    <option select="selected" value="<?php echo $row_from_own['order_details_id'];?>"><?php echo $row_style_name['style_name'];?></option>
        ...
        <td><input type="text" class="form-control" id="total_daily_completed_quantity_<?php echo $counter;?>" name="total_daily_completed_quantity_<?php echo $counter;?>" disabled></td>
        <td><input type="text" class="form-control" id="wip_<?php echo $counter;?>" name="wip_<?php echo $counter;?>" disabled></td>
        <td><input type="text" class="form-control" id="quantity_<?php echo $counter;?>" name="quantity_<?php echo $counter;?>" value="<?php echo $row_from_own['quantity']?>" required></td>
        <td><input type="text" class="form-control" id="man_power_<?php echo $counter;?>" name="man_power_<?php echo $counter;?>" value="<?php echo $default_man_power?>" disabled></td>
        <td>
