...
<script>
 ...
 function sending_data_for_delete(buyer_id)
 {
       ...
       var url_encoded_form_data = 'customer_id='+buyer_id;
       
		  	 $.ajax({
			 		url: 'settings/buyer_deleting.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
			 		data: url_encoded_form_data,
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading text-center" style="color:#191970;"><h3><b>Buyer</b></h3></div> <!-- This will create a upper block for FORM (Just Beautification) -->
		...
		<div class="panel-heading text-center"><h3><b>Buyer List</b></h3></div>
        ...
        <div class="form-group form-group-sm">
			         ...
			         <table id="datatable-buttons" class="table table-striped table-bordered">
			            ...
			            <?php 
			                            $s1 = 1;
			                            $sql_for_color = "SELECT * FROM buyer ORDER BY row_id ASC";
			             ...
			             <tr>
			                ...
			                <td>
			                        ...
			                        <button type="submit" id="" name="" class="btn btn-primary btn-xs" onclick="load_page('settings/edit_buyer.php?buyer_id=<?php echo $row['buyer_id']?>')"> Edit </button>
