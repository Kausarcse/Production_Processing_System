...
/***********************************Test Report*************************************/
	...
	function change_pp_status_report_button_color() {
		...
		$('#add_style_details').css('background', 'none');		
	...
	function menu_back_color()
	{
		...
		$('#pp_status_report').css('background', 'none');
		$('#add_style_details').css('background', 'none');		
		$('#add_order_details').css('background', 'none');	
		$('#add_plan_details').css('background', 'none');	
		$('#add_production_details').css('background', 'none');	

		$('#swing_day_input').css('background', 'none');	
		$('#swing_production_panning').css('background', 'none');	

		$('#add_man_per_line').css('background', 'none');	
		$('#output_board').css('background', 'none');	

		$('#target_set_line').css('background', 'none');	
		$('#hourly_output_board').css('background', 'none');	
		$('#line_wise_output_per_hour').css('background', 'none');
        $('#hourly_target_vs_achivement_output_board').css('background', 'none');

		
	}

    function hourly_target_vs_achivement_output_board()
    {	menu_back_color();
        $('#hourly_target_vs_achivement_output_board').css('background', 'black');
        load_page('Output_Board/hourly_target_vs_achivement_output_board.php');

    }
	
	function add_style_details()
	{

		//	$('#create_user_list').css(black, none);
		
		menu_back_color();

		$('#add_style_details').css('background', 'black');	
		load_page('Style_Details/style_detials.php');
	}
	...
	$('#add_order_details').css('background', 'black');	
	load_page('Order_Details/order_details.php');
	}
	...
	function add_plan_details()
	{
		...
		$('#add_plan_details').css('background', 'black');	
		load_page('Plan_Details/plan_details.php');
	}
	...
	$('#add_production_details').css('background', 'black');	
	load_page('Production_Details/production_details.php');
	}

	function swing_day_input()
	{		menu_back_color();
		$('#swing_day_input').css('background', 'black');	
	load_page('swing/swing_day_input.php');

	}

	function swing_production_panning()
	{		menu_back_color();
		$('#swing_production_panning').css('background', 'black');	
	load_page('swing/swing_production_panning.php');

	}

	function add_man_per_line()
	{	menu_back_color();
		$('#add_man_per_line').css('background', 'black');	
		load_page('Line_Details/add_man_per_line.php');
	}
	function target_set_line()
	{	menu_back_color();
		$('#target_set_line').css('background', 'black');	
		load_page('Line_Details/target_set_line.php');
	}

	
	function line_wise_output_per_hour()
	{
		menu_back_color();
		$('#line_wise_output_per_hour').css('background', 'black');	
		load_page('Line_Details/line_wise_output_per_hour.php');

	}

	function output_board()
	{	menu_back_color();
		$('#output_board').css('background', 'black');	
		load_page('Output_Board/output_board.php');
	}
	function hourly_output_board()
	{	menu_back_color();
		$('#hourly_output_board').css('background', 'black');	
		load_page('Output_Board/hourly_output_board.php');
...
<!-- Add All Your Left Side Menu=>Submenu From Here in Accordion Menu -->
	...
	<div id="accordion" class="accordion_menu">
		...
		<h3 style="font-size: 13px; color:#FFFFFF; background:none;">Style Details</h3>
		<div style="padding-left:7px;">

		<button class="sub_menu panel text-left" onclick="add_style_details()" id="add_style_details"><span style="font-size: 11px;">Add Style Detials</span></button>

		</div>
		
		<h3 style="font-size: 13px; color:#FFFFFF; background:none;">Order Details</h3>
		<div style="padding-left:7px;">

		<button class="sub_menu panel text-left" onclick="add_order_details()" id="add_order_details"><span style="font-size: 11px;">Add Order Detials</span></button>

		</div>

		<h3 style="font-size: 13px; color:#FFFFFF; background:none;">Plan Details</h3>
		<div style="padding-left:7px;">

		<button class="sub_menu panel text-left" onclick="add_plan_details()" id="add_plan_details"><span style="font-size: 11px;">Add Plan Detials</span></button>

		</div>


		<h3 style="font-size: 13px; color:#FFFFFF; background:none;">Cutting</h3>
		<div style="padding-left:7px;">

		<button class="sub_menu panel text-left" onclick="add_production_details()" id="add_production_details"><span style="font-size: 11px;">Add Production Detials</span></button>
		...
		<h3 style="font-size: 13px; color:#FFFFFF; background:none;">Swing</h3>
		<div style="padding-left:7px;">

<!--		<button class="sub_menu panel text-left" onclick="swing_day_input()" id="swing_day_input"><span style="font-size: 11px;">Daily Input for Sewing</span></button>-->
		
		<button class="sub_menu panel text-left" onclick="swing_production_panning()" id="swing_production_panning"><span style="font-size: 11px;">Sewing Production Planning</span></button>
		...
		<h3 style="font-size: 13px; color:#FFFFFF; background:none;">Line Details</h3>
		<div style="padding-left:7px;">

		<button class="sub_menu panel text-left" onclick="add_man_per_line()" id="add_man_per_line"><span style="font-size: 11px;">Man Power Set Per Line</span></button>
		
		<button class="sub_menu panel text-left" onclick="target_set_line()" id="target_set_line"><span style="font-size: 11px;">Target Output Set Per Line</span></button>
		
		<button class="sub_menu panel text-left" onclick="line_wise_output_per_hour()" id="line_wise_output_per_hour"><span style="font-size: 11px;">Line Wise Output Per Hour</span></button>

		
		</div>

		<h3 style="font-size: 13px; color:#FFFFFF; background:none;">Output Board Details</h3>
		<div style="padding-left:7px;">
            <button class="sub_menu panel text-left" onclick="hourly_target_vs_achivement_output_board()" id="hourly_target_vs_achivement_output_board"><span style="font-size: 11px;">Hourly Target Vs Achivement Output board</span></button>

<!--		<button class="sub_menu panel text-left" onclick="hourly_output_board()" id="hourly_output_board"><span style="font-size: 11px;">Hourly Output board</span></button>-->
		<button class="sub_menu panel text-left" onclick="output_board()" id="output_board"><span style="font-size: 11px;">Full Output board</span></button>
