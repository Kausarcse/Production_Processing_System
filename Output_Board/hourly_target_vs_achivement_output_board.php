        ...
        <div id="element">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a onclick="load_page('swing/swing_production_info.php')">Hourly Target Vs Achivement Output Board</a></li>
                </ol>
            </nav>
        </div>
        <?php

//       echo $select_sql_for_duplicacy="select style_details_id as order_details_id,ship_date,color,
//po,line_no,new_target ,
//input_date,
...
// ) as navid GROUP BY
// style_details_id,ship_date,color,
//po,
//input_date";

        //created a view hourly_output_report_view
        $select_sql_for_duplicacy="select * from hourly_output_report_view";

//created a procudure  hourly_output_report()
                        ...
                        if(mysqli_num_rows($result)>0)
                        {
                            ...
                            while( $row = mysqli_fetch_array( $result))
                            {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $new_target=$row['new_target'];?></td>
                                    <?php
                                    for ($i=1;$i<=16;$i++)
                                    {
                                        ?>
                                        <td><?php echo $row['Hour_'.$i]?></td>
                                        <?php
                                    }
